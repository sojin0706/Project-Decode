    ...
    return (
        <>
            <Modal
                ...
                open={open}
                trigger={isImage?
                    <button><img src={item.url} alt="url" width={w} height={h} /></button>
                :
                    <Button>{item.name}</Button>
                }
                // trigger={<Button><img src={item.name} alt="url" width="150" height="150" /></Button>}
                // trigger={<button><img src={item.url} alt="url" width="150" height="150" /></button>}
                >
                <Modal.Content image>
